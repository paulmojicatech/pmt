...
const FAX = '(866) 706-1632';
const ADDRESS = `8211 Avanti Drive
Marvin, NC 28173`;
const BUSINESS_NAME = 'Kirstin R. Abraham, LCSW';

const INIDIVIDUAL_TYPE_DESCRIPTION = `As a clinical psychotherapist, I work from different theoretical perspectives to meet
