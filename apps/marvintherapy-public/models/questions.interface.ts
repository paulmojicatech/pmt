...
export const COMMON_QUESTIONS_MODEL: CardProps[] = [
  ...
  {
    type: CardType.WHY_DO_PEOPLE_GO,
    cardTitle:
  ...
  {
    type: CardType.WHAT_IS_IT_LIKE,
    cardTitle: 'What is therapy like?',
    cardDescription:
  ...
  {
    type: CardType.MEDICATION_VS_PSYCHOTHERAPY,
    cardTitle: 'What about medication vs. psychotherapy?',
    cardDescription:
  ...
  {
    type: CardType.DO_YOU_TAKE_INSURANCE,
    cardTitle: 'Do you take insurance, and how does that work?',
    cardDescription:
  ...
  } as DoYouTakeInsurance,
  {
    type: CardType.IS_IT_CONFIDENTIAL,
    cardTitle: 'Does what we talk about in therapy remain confidential?',
    cardDescription:
